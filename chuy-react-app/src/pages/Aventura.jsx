      ...
      try {
        ...
        if (aventuraSnap.exists()) {
          ...
          if (inglesSnap.exists()) {
            ...
            // Intentar en colección 'piano'
            const pianoRef = doc(db, 'piano', fecha);
            const pianoSnap = await getDoc(pianoRef);
            if (pianoSnap.exists()) {
              setAventura({
                id: pianoSnap.id,
                ...pianoSnap.data()
              ...
              if (cienciasSnap.exists()) {
                ...
                if (dibujoSnap.exists()) {
                  ...
                  // Intentar en colección 'geografia'
                  const geografiaRef = doc(db, 'geografia', fecha);
                  const geografiaSnap = await getDoc(geografiaRef);
                  if (geografiaSnap.exists()) {
                    setAventura({
                      id: geografiaSnap.id,
                      ...geografiaSnap.data()
                    });
