 ...
 */
const ESCENAS = ['planetas', 'tierra-luna', 'estaciones', 'constelaciones', 'cometa', 'satelite', 'estrellas', 'exoplanetas', 'agujero-negro', 'cama-elastica'];
...
const EMOJI_ESCENA = { 'tierra-luna': '🌗', estaciones: '🍂', constelaciones: '✨', cometa: '☄️', satelite: '🛰️', estrellas: '⭐', exoplanetas: '🔭', 'agujero-negro': '🕳️', 'cama-elastica': '🛏️' };
